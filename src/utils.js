const UTILS = {
  tokenAbi: [
    ...
    { anonymous: false, inputs: [{ indexed: false, internalType: "address", name: "account", type: "address" }], name: "Unpaused", type: "event" },
    {
      inputs: [
        ...
        { internalType: "uint256", name: "_vestStart", type: "uint256" },
        { internalType: "uint256", name: "_vestEnd", type: "uint256" },
        { internalType: "bool", name: "_status", type: "bool" },
      ],
      name: "activateUserVesting",
    ...
    },
    {
      inputs: [
        { internalType: "address", name: "_tokenHolder", type: "address" },
        { internalType: "uint256", name: "_index", type: "uint256" },
        { internalType: "uint256", name: "_tokenClaimable", type: "uint256" },
        { internalType: "bool", name: "_status", type: "bool" },
    ...
    { inputs: [], name: "symbol", outputs: [{ internalType: "string", name: "", type: "string" }], stateMutability: "view", type: "function" },
    {
      ...
      outputs: [
        ...
        { internalType: "uint256", name: "tokenClaimable", type: "uint256" },
        { internalType: "bool", name: "vestingRelease", type: "bool" },
  ...
  airDropAbi: [
    { inputs: [{ internalType: "address", name: "_mehgToken", type: "address" }], stateMutability: "nonpayable", type: "constructor" },
    {
      anonymous: false,
      inputs: [
        { indexed: true, internalType: "address", name: "previousOwner", type: "address" },
      ...
      outputs: [
        {
          ...
          internalType: "struct Airdrop.airdrop",
          name: "",
          type: "tuple",
        },
      ],
    ...
    {
      inputs: [{ internalType: "uint256", name: "_vestingMonths", type: "uint256" }],
      name: "approveAirdrop",
      outputs: [],
      stateMutability: "nonpayable",
      type: "function",
    ...
    { inputs: [], name: "getAirdropStatus", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
    {
      inputs: [{ internalType: "address", name: "_referrer", type: "address" }],
      name: "getReferral",
      outputs: [
        {
          components: [{ internalType: "address", name: "referred", type: "address" }],
          internalType: "struct Airdrop.referral[]",
          name: "",
          type: "tuple[]",
        },
      ],
    ...
    { inputs: [], name: "owner", outputs: [{ internalType: "address", name: "", type: "address" }], stateMutability: "view", type: "function" },
    { inputs: [], name: "pauseAirdrop", outputs: [], stateMutability: "nonpayable", type: "function" },
    { inputs: [], name: "paused", outputs: [{ internalType: "bool", name: "", type: "bool" }], stateMutability: "view", type: "function" },
    {
      inputs: [
        { internalType: "address", name: "", type: "address" },
      ...
      name: "referrals",
      outputs: [{ internalType: "address", name: "referred", type: "address" }],
      stateMutability: "view",
      type: "function",
    },
    {
      inputs: [{ internalType: "address", name: "", type: "address" }],
      name: "referralsClaimed",
      outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
      stateMutability: "view",
      type: "function",
    },
    ...
    { inputs: [], name: "unpauseAirdrop", outputs: [], stateMutability: "nonpayable", type: "function" },
  ],
  privateSaleAbi: [
    {
      inputs: [
        { internalType: "address", name: "_mehgToken", type: "address" },
    ...
    },
    {
      ...
      inputs: [
        { indexed: true, internalType: "address", name: "_from", type: "address" },
        { indexed: true, internalType: "address", name: "_destAddr", type: "address" },
        { indexed: false, internalType: "uint256", name: "_amount", type: "uint256" },
      ],
      name: "TransferSent",
      type: "event",
    ...
    },
    {
      ...
      outputs: [
        { internalType: "address", name: "tokenHolder", type: "address" },
        { internalType: "uint256", name: "tokenClaimable", type: "uint256" },
        { internalType: "bool", name: "vestingClaimed", type: "bool" },
      ],
      stateMutability: "view",
      type: "function",
    },
    {
      inputs: [],
      name: "getFirstPrivateSalesStatus",
      outputs: [{ internalType: "bool", name: "", type: "bool" }],
      stateMutability: "view",
      type: "function",
    },
    ...
    {
      inputs: [{ internalType: "uint256", name: "_unlockSchedule", type: "uint256" }],
      name: "releaseVestedToken",
      outputs: [{ internalType: "bool", name: "", type: "bool" }],
      stateMutability: "nonpayable",
      type: "function",
    },
    ...
    {
      inputs: [
        { internalType: "uint256", name: "_unlockSchedule", type: "uint256" },
        { internalType: "uint256", name: "_vestingMonths", type: "uint256" },
    ...
    },
    {
      ...
      outputs: [
        { internalType: "uint256", name: "vestingEnd", type: "uint256" },
        { internalType: "uint256", name: "vestingCreated", type: "uint256" },
  ...
  tokenAddress: "0x2a8E3B8ee1443e0e85A4F32A7B68D2B5E77D2865",
  airdropAddress: "0xD66e23477a67935158f88CEc0eb593d7ea0dFBCD",
  saleAddress_1: "0x6F15cD5FBd4fbA78B8b261c0623013c3256a5e2e",
  saleAddress_2: "0x51d5cB4018E8c9a1753c567A12A68618f09EC434",
  seedAddress: "0x275747359Eb9634C8291a11c2fBFd61465Ba9642",
  ...
  sale_1_details: {
    ...
    supply: "3,000,000 MEHG",
    tge: "TGE - 7% [Full Unlocking Period - 5 Months]",
    unlock_plan: "(93%) 1st Month 5%, 2nd 8%, 3rd 10%, 4th 30%, 5th 40%",
    pricing: "1 MEHG - $0.06",
    min: "$50 BUSD = 833.3 MEHG",
    max: "$1,500 BUSD = 25,000 MEHG",
    address: "0x6F15cD5FBd4fbA78B8b261c0623013c3256a5e2e",
    price: 0.06,
    min_buy: 50,
    max_buy: 1500,
  },
  sale_2_details: {
    ...
    supply: "3,500,000 MEHG",
    tge: "TGE - 10% [Full Unlocking Period - 5 Months]",
    unlock_plan: "(90%) 1st Month 5%, 2nd 10%, 3rd 20%, 4th 25%, 5th 30%",
    pricing: "1 MEHG - $0.075",
    min: "$50 BUSD = 666.6 MEHG",
    max: "$1,500 BUSD = 20,000 MEHG",
    address: "0x51d5cB4018E8c9a1753c567A12A68618f09EC434",
    price: 0.075,
    min_buy: 50,
    max_buy: 1500,
  },
  seed_details: {
    title: "Seed Sale",
    supply: "4,500,000 MEHG",
    tge: "TGE - 5% [Full Unlocking Period - 6 Months]",
    unlock_plan: "(95%) 1st Month 5%, 2nd 5%, 3rd 10%, 4th 15%, 5th 25%, 6th 35%",
    pricing: "1 MEHG - $0.04",
    min: "$2,000 BUSD = 50,000 MEHG",
    max: "$5,000 BUSD = 125,000 MEHG",
    price: 0.04,
    min_buy: 2000,
    max_buy: 5000,
    address: "0x275747359Eb9634C8291a11c2fBFd61465Ba9642",
  },
};
